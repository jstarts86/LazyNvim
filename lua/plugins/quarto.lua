return {
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<localleader>rc", "i`<c-j>", { desc = "Create a new code cell", silent = true })
      vim.keymap.set("n", "<localleader>rs", "i```\r\r```{}<left>", { desc = "Split code cell", silent = true, noremap = true })
